...
describe('Validate', function () {
  /* jshint expr:true */
	...
	describe('isPic', function () {
		it('loremipsum is not a valid picture url', function () {
	      validate.oneOf('lorem ipsum').should.be.false;
	    });
	    it('https://i.imgur.com/FG2wcV7.gif is a valid picture url, merry christmas', function () {
	    	validate.oneOf('https://i.imgur.com/FG2wcV7.gif').should.be.true;
	    });
	});
